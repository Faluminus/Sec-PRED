...
data = pd.read_csv("../data/processed/PKAD2_CLEANED.csv")

tokenizer = AutoTokenizer.from_pretrained("facebook/esm2_t6_8M_UR50D")

src_data_ac = data['Expt. pKa'].astype(str).tolist()
src_data_pH_high = data['pH_high'].astype(float).tolist()
src_data_pH_low = data['pH_low'].astype(float).tolist()
#src_data_kelvin = data['Kelvin_standardized'].astype(float).tolist()
tgt_data = data['Expt. pKa'].astype(str).tolist()
