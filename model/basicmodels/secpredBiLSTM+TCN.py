...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(128, return_sequences=True, activation='relu', dropout=0.4, kernel_regularizer=L2(0.01))),
    TCN(nb_filters=32, kernel_size=19, dilations=[1, 2, 4, 8], return_sequences=True),
    tf.keras.layers.Dense(max_features, activation='softmax')
])
...
model.save('./../trained/secpredBiLSTM+TCN.keras')
