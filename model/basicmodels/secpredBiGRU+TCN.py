...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Bidirectional(tf.keras.layers.GRU(128, return_sequences=True, activation='relu', dropout=0.4, kernel_regularizer=L2(0.01))),
...
model.save('./../trained/secpredBiGRU+TCN.keras')
