<script>
  ...
  function rowBlocks(incr){
    ...
    for (let i = 0; i < height; i++) {
      ...
      let insides = [getAminoAcids(i * rowLen , i * rowLen + rest), makeVisualization(i * rowLen, i * rowLen + rest)];
      data = [...data, insides];
      y += incr;
    }
    return data;
...
<svg class='overflow-visible' viewBox="0 0 940 {height*incr}" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
