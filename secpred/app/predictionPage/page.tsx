...
const PredictionPage = () =>{
    ...
    const [secStructureSeq,setSecStructureSeq] = useState()
                ...
                <div className="flex flex-col h-[100%] w-[50vw] gap-3">
                    <div className='w-[50px] h-[50px]'>
                        <div className='absolute flex flex-row items-center gap-2'>
                            ...
                            <input ref={buttonRef} value={proteinID} onChange={(e)=>{setProteinID(e.target.value)}} className='rounded-box bg-white w-[200px] h-[40px] flex items-center p-3 rounded-xl shadow-2xl font-[200]' placeholder='Protein id'></input>
                        </div>
                    </div>
