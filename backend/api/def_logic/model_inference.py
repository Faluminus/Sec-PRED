...
class Inference():
    def __init__(self):
        ...
        self.conv = tf.keras.models.load_model('./prediction_models/convolutionalSecPRED.keras')
        self.lstm = tf.keras.models.load_model('./prediction_models/lstmSecPRED-PREDICTION.keras')
